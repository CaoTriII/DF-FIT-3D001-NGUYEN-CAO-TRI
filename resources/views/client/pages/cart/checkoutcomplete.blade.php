            ...
            <div class="form-content3">
                <div class="payment-received-list">
                    ...
                    <ul class="list-items py-4">
                        <li><i class="la la-check text-success mr-2"></i>Your <strong class="text-black">payment</strong> will be handled by the Hotel Owner</li>
                    ...
                    <div class="btn-box">
                        <a href="{{route('client.index')}}" class="theme-btn border-0 text-white bg-7" style="text-decoration: none;color:rgb(255, 255, 255)">Return to Home</a>
                    </div>
                </div><!-- end card-item -->
